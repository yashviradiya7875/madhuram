                        ...
                        <div class="ar-about-us-4-title-box d-flex justify-content-end">
                            ...
                            <div class="ar-about-us-4-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="81" height="9" viewBox="0 0 81 9"
                                    ...
                                    <path d="M77 7.96366L80.5 4.48183L77 1" stroke="#111013" stroke-linecap="round"
                                ...
                                <div class="ar-step-top d-flex justify-content-between align-items-center">
                                    <span class="ar-step-icon">
                                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M20.2149 14.8932C19.5786 16.3981 18.5833 17.7241 17.3161 18.7554C16.0489 19.7868 14.5484 20.492 12.9456 20.8094C11.3429 21.1268 9.68686 21.0468 8.12222 20.5764C6.55758 20.1059 5.132 19.2593 3.97012 18.1106C2.80824 16.962 1.94544 15.5461 1.45715 13.987C0.968852 12.4278 0.869934 10.7728 1.16904 9.16654C1.46815 7.56032 2.15617 6.05181 3.17296 4.77291C4.18975 3.49402 5.50434 2.48367 7.00181 1.8302"
                                                stroke="white" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path
                                                d="M21.005 11.0023C21.005 9.6888 20.7463 8.38814 20.2436 7.1746C19.741 5.96106 19.0042 4.85842 18.0754 3.92961C17.1466 3.00081 16.044 2.26405 14.8304 1.76138C13.6169 1.25872 12.3162 1 11.0027 1V11.0023H21.005Z"
                                                stroke="white" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                        </svg>
                                ...
                                <div class="ar-step-top d-flex justify-content-between align-items-center">
                                    <span class="ar-step-icon">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M10 1L1 5.5L10 10L19 5.5L10 1Z" stroke="white" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M1 14.5L10 19L19 14.5" stroke="white" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M1 10L10 14.5L19 10" stroke="white" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    </span>
                                ...
                                <div class="ar-step-top d-flex justify-content-between align-items-center">
                                    <span class="ar-step-icon">
                                        <svg width="20" height="22" viewBox="0 0 20 22" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M11 1L1 13H10L9 21L19 9H10L11 1Z" stroke="white" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    </span>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="tp-pd-3-portfolio-thumb">
                            <img class="w-100" src="assets/img/portfolio/portfolio-details-3/port-5.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
        ...
        <div class="tp-pd-3-portfolio-item-wrap pt-120">
            <div class="tp-pd-3-portfolio-item mb-120">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="tp-pd-3-portfolio-thumb">
                            <img class="w-100" src="assets/img/portfolio/portfolio-details-3/port-6.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
